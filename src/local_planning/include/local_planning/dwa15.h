...
public:
    ...
    void SelfCallback(const custom_messages::status15::ConstPtr& self_msg);
    ...
    void Status15toCarstate(const custom_messages::status15::ConstPtr& input, CarState& output);
